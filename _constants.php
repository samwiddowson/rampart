...
$setting_defaults = [
    ...
    "POST_LEVEL_MAP_NAME" => "HUBMAP",
    "GUIDE_MAP_NAME" => "HUBMAP",
    ...
    "PROJECT_ALLOWED_MAPINFO_PROPERTIES" => [
...
const WORK_FOLDER           = RAMPART_HOME . "work" . DIRECTORY_SEPARATOR;
...
const UPLOADS_FOLDER        = WORK_FOLDER . "uploads" . DIRECTORY_SEPARATOR;
const PK3_FOLDER            = WORK_FOLDER . "pk3" . DIRECTORY_SEPARATOR;
...
const STATIC_CONTENT_FOLDER = DATA_FOLDER . "fixedcontent" . DIRECTORY_SEPARATOR;

const MAPS_FOLDER           = PK3_FOLDER . "maps" . DIRECTORY_SEPARATOR;
...
$ZIP_SCRIPT_WINDOWS         = "cd /d " . PK3_FOLDER . " && del \"" . get_project_full_path() . "\" && \"c:\\Program Files\\7-Zip\\7z.exe\" a \"" . get_project_full_path() . "\" *";
...
const COMPILE_ERRORS = [
    ...
    'ERR_SOUND_AMBIENT_REDEFINITION' => 'SNDINFO tries to define ambient index $1 as $2, but it\'s already reserved by map $3',
